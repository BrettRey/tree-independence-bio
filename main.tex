...
\textcite{alavi1987vertex} conjectured that every tree's independence polynomial is unimodal. Despite decades of partial results~-- including special cases such as paths, caterpillars, and spiders~-- the conjecture remains open \citep{levit2005independence}. \textcite{reynolds2026erdos} verified it computationally for all 447\,672\,596 trees on at most 26~vertices.
...
The reduction has practical implications for biological networks. Hub vertices~-- proteins with many single-degree interaction partners, transcription factors with many targets~-- are automatically excluded from 1-Private configurations while their partners are included.
